...
Section LaxRightIdentity.
  ...
  Definition lax_right_identity_d
    : LaxTransformation_d (lax_comp F (lax_id_functor C)) F.
  Proof.
  ...
  Definition is_lax_lax_right_d
    : is_lax_transformation lax_right_identity_d.
  Proof.
    split.
    - intros X ; cbn.
  ...
  Definition lax_right_identity
    ...
    := Build_LaxTransformation lax_right_identity_d is_lax_lax_right_d.
