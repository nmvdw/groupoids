...
Section LaxLeftIdentityInv.
  ...
  Definition lax_left_identity_inv_d
    : PseudoTransformation_d F (lax_comp (lax_id_functor D) F).
  Proof.
  ...
  Definition is_lax_left_inv_d
    : is_pseudo_transformation_p lax_left_identity_inv_d.
  Proof.
  ...
  Definition lax_left_identity_inv
    ...
    := Build_PseudoTransformation lax_left_identity_inv_d is_lax_left_inv_d.
