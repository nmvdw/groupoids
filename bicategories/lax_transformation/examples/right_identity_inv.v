...
Section LaxRightIdentityInv.
  ...
  Definition lax_right_identity_inv_d
    : LaxTransformation_d F (lax_comp F (lax_id_functor C)).
  Proof.
  ...
  Definition is_lax_lax_right_inv_d
    : is_lax_transformation lax_right_identity_inv_d.
  Proof.
    split.
    - intros X ; cbn.
  ...
  Definition lax_right_identity_inv
    ...
    := Build_LaxTransformation lax_right_identity_inv_d is_lax_lax_right_inv_d.
