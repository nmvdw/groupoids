...
Section LaxAssociativity.
  ...
  Definition lax_associativity_d
    : LaxTransformation_d (lax_comp (lax_comp F₃ F₂) F₁) (lax_comp F₃ (lax_comp F₂ F₁)).
  Proof.
  ...
  Definition is_lax_associativity_d
    : is_lax_transformation lax_associativity_d.
  Proof.
    split.
    - intros X ; cbn.
      ...
      cbn in p.
      rewrite p, associativity, p ; clear p.
      rewrite <- !associativity.
  ...
  Definition lax_associativity
    ...
    := Build_LaxTransformation lax_associativity_d is_lax_associativity_d.
