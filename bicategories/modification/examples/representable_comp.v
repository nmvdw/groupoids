...
Section UnivalentRepresentableComp.
  Context `{Univalence}
          {C : BiCategory}
          `{LocallyUnivalent C}
          {X₁ X₂ X₃ : C}.
  ...
  Definition univalent_representable_comp_d
    : Modification_d
        (composition.compose
           (univalent_representable1 f)
           (univalent_representable1 g))
        (univalent_representable1 (g · f)).
  Proof.
    intros Z.
    simple refine (Build_NaturalTransformation _ _ _ _).
    - intros h ; cbn in *.
  ...
  Definition univalent_representable_comp_is_modification
    : is_modification univalent_representable_comp_d.
  Proof.
    intros Z₁ Z₂ h.
    apply path_natural_transformation.
    intros φ ; cbn in *.
  ...
  Definition univalent_representable_comp
    : Modification
        (composition.compose
           (univalent_representable1 f)
           (univalent_representable1 g))
        (univalent_representable1 (g · f))
    := Build_Modification
         univalent_representable_comp_d
         univalent_representable_comp_is_modification.
End UnivalentRepresentableComp.

Section UnivalentRepresentableCompInv.
  Context `{Univalence}
          {C : BiCategory}
          `{LocallyUnivalent C}
          {X₁ X₂ X₃ : C}.
  ...
  Definition univalent_representable_comp_inv_d
    : Modification_d
        (univalent_representable1 (g · f))
        (composition.compose
           (univalent_representable1 f)
  ...
  Definition univalent_representable_comp_inv_is_modification
    : is_modification univalent_representable_comp_inv_d.
  Proof.
    intros Z₁ Z₂ h.
    apply path_natural_transformation.
    intros φ ; cbn in *.
  ...
  Definition univalent_representable_comp_inv
    : Modification
        (univalent_representable1 (g · f))
        (composition.compose
           (univalent_representable1 f)
           (univalent_representable1 g))
    := Build_Modification
         univalent_representable_comp_inv_d
         univalent_representable_comp_inv_is_modification.
End UnivalentRepresentableCompInv.